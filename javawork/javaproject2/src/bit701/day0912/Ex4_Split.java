...
//		String []str3Array = str3.split("[|]");
		...
		System.out.println("-".repeat(20));
		int count=st2.countTokens(); // countTokens가 for문이 돌때마다 갯수가 바껴서 초기값을 입력해줘야함
		for(int i=0;i<st2.countTokens();i++) { //for문 한번 돌때마다 counttokens가 5-> 4->3 이런식으로 내려감

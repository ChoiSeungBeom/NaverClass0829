...
public class Ex3_SwingGibon extends JFrame {

	public Ex3_SwingGibon(String title) {
...
//		this.getContentPane().setBackground(Color.green); //Color 상수를 이용해서 변경
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) { // x버튼 클릭시 호출되는 메서드
				...
				JOptionPane.showMessageDialog(Ex3_SwingGibon.this, "프레임을 종료합니다");
				// 실제종료
				System.exit(0); // 정상종료
				super.windowClosing(e);
			}
	...
	public static void main(String[] args) {
		Ex3_SwingGibon s = new Ex3_SwingGibon("안녕");
	}

...
public class Ex15_ListStudent {
	...
	public void deleteStudent() {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (student.getName().equals(name)) {
				...
				return; // 학생이름이 발견되고 제거되면 루프를 빠져나간다
			}
		}
	...
	public void searchStudent() {
		...
		for (int i = 0; i < list.size(); i++) {
			Student student = list.get(i);
			if (student.getName().equals(info)) {
				System.out.println("이름 : "+student.getName());
				System.out.println("점수 : "+student.getScore());
				System.out.println("혈액형 : "+student.getBlood());
				return;
			}
		}
		System.out.println(info + "님은 명단에 없습니다.");
	...
	public void listStudent() {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			System.out.println("이름 : "+student.getName());
			System.out.println("점수 : "+student.getScore());
			System.out.println("혈액형 : "+student.getBlood().toUpperCase());
			System.out.println();

...
public class Ex10_SawonInput {
	...
	public static void main(String[] args) {
		...
		//출력
		System.out.println("이름\t기본급\t수당\t가족수\t가족수당\t실수령액");
		System.out.println("=".repeat(50));
		for(Sawon s:sa)
			System.out.println(s.getName()+"\t"+s.getGibon()+"\t"+s.getSudang()+"\t"+s.getFamilySu()+"\t"+s.getFamilySudang()+"\t"+s.getNetPay());
	}

...
<form action="./myshopinsert.jsp" method="post">
	<table class="table table-bordered" style="width: 300px;">
		...
		<tr>
			...
			<td>
				<input type="text" name="sangpum" class="form-control" placeholder="상품명" required="required" autofocus="autofocus">
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="color" name="color" class="form-control" required="required" value="#cccccc">
			</td>
		</tr>

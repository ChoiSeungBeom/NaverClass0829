   ...
   <script type="text/javascript">
   	$(function(){
   		...
   		$("img.small").click(function(){
   			...
   			//es6 의 리터럴 문자 사용 시 - jsp자체적으로 $기능이 있으므로 앞에 \를 붙여서 변수를 가져온다
   			location.href=`myshopdetail.jsp?num=\${num}`;
   			//location.href="myshopdetail.jsp?num="+num;
   		});
   	});
...
<body>
	...
	<button type = "button" class = "btn btn-outline-info btn-sm" style = "height:54px; float: right;" onclick = "location.href='myshopinform.jsp'">상품등록</button>
	</h5>

	</div>
	<table class="table table-bordered shoptb" style="width:600px; text-align: center;">
		<thead>
			<tr>
				<th width="50">번호</th>
				<th width="150">상품명</th>
		...
		<%
			...
			for(MyShopDto dto:list){%>
				...
				<td>
					<div class="box" style="background-color: <%=dto.getColor() %>">
				...
				<td>
					<button type="button" class="btn btn-sm btn-danger del" num="<%=dto.getNum()%>" class=" del">삭제</button>

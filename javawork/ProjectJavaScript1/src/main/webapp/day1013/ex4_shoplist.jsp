...
<body>
	...
	<%
		...
		list.add(new ShopDto("보석머리끈","30",15000,"purple"));
		list.add(new ShopDto("뿌띠스카프","10",59000,"magenta"));
		list.add(new ShopDto("화이트자켓","31",23000,"skyblue"));
	%>
	...
	%>
			<tr>
				...
				<td><img src= "../shop/<%=dto.getPhoto()%>.jpg"  id="box"></td>
				<td style="background-color:<%=dto.getColor()%>; "><%=dto.getColor()%></td>
			</tr>
	<%
		}
	%>

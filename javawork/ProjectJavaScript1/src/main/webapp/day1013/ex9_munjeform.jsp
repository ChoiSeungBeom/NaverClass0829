...
<body>
   ...
   &nbsp;
   <label>
      <input type="radio" name="line" value="10px double orange">더블선
   </label>
   &nbsp;
   <label>
      <input type="radio" name="line" value="5px groove gold">그루브선
   </label>
   <br><br>
   <h5>사진을 선택해주세요</h5>
   <select class="form-select" style="width:120px"name="img" >
